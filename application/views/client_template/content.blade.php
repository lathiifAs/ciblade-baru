...
<section class="ftco-section ftco-no-pt ftco-no-pb">
    <div class="container">
        <div class="row no-gutters">
            <div class="col-md-5 p-md-5 img img-2 mt-5 mt-md-0" style="background-image: url({{ base_url('assets/client_template/images/about.jpg') }});">
            </div>
            <div class="col-md-7 wrap-about py-4 py-md-5 ftco-animate">
                ...
                <div class="pl-md-5 ml-md-5 mb-5">
                    ...
                    <div class="founder d-flex align-items-center mt-5">
                        <div class="img" style="background-image: url({{ base_url('assets/client_template/images/doc-1.jpg') }});"></div>
                        <div class="text pl-3">
