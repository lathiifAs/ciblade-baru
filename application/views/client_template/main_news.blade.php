            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6">
                    <div class="single_industries">
                        <img src="{{ base_url('assets/client_template/img/ind/industries_1.png') }}" alt="">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single_industries">
                        <img src="{{ base_url('assets/client_template/img/ind/industries_2.png') }}" alt="">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single_industries">
                        <img src="{{ base_url('assets/client_template/img/ind/industries_3.png') }}" alt="">
