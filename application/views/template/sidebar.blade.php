        ...
        <div class="nano">
            <div class="nano-content">
                <ul>
                    ...
                    <li><a target="_blank" href="{{ base_url('assets/template_master/nixon-free/index.html') }}"><i class="ti-file"></i> Documentation</a></li>
                    ...
                    @if($user_login['role_nm'] == 'developer')
                        <li @if (!empty($seg_menu) and $seg_menu == 'role') class="active" @endif>
                                ...
                                <ul>
                                    ...
                                    <li><a href="{{ site_url('sistem/permission') }}">Hak Akses</a></li>
                                </ul>
                        </li>
                    @endif
