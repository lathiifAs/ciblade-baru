                    ...
                    <div class="card alert">
                        <div class="card-header">
                            ...
                            <div class="card-header-right-icon">
                                <ul>
                                    <a href="<?php  echo site_url('sistem/group')  ?>" type="button" class="btn btn-default m-b-10 m-l-5">Kembali</a>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="card-body" style="margin-top:20px">
                            ...
                            <div class="main">
                                    <div class="horizontal-form-elements">
                                            <form class="form-horizontal" action="<?php  echo site_url('sistem/group/add_process')  ?>" method="post">
                                                <div class="row">
                                                    <div class="col-lg-6">
