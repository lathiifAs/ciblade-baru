                    ...
                    <div class="card alert">
                        <div class="card-header">
                            ...
                            <div class="card-header-right-icon">
                                <ul>
                                    <a href="<?php  echo site_url('master/user')  ?>" type="button" class="btn btn-default m-b-10 m-l-5">Kembali</a>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="card-body" style="margin-top:20px">
                            ...
                            <div class="main">
                                    <div class="horizontal-form-elements">
                                            <form class="form-horizontal" action="<?php  echo site_url('master/user/add_process')  ?>" method="post">
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <label class="col-sm-2 control-label">Nama</label>
                                                            <div class="col-sm-10">
                                                                <input type="text" name="nama" class="form-control" placeholder="Isian nama...">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <textarea class="col-sm-12" name="alamat" placeholder="Alamat lengkap..."></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                    <input type="text" name="user_mail" class="form-control" placeholder="Isian email...">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-sm-2 control-label">Username</label>
                                                            <div class="col-sm-10">
                                                                <input type="text" name="user_name" class="form-control" placeholder="Isian username...">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
