                        ...
                        <div class="card-body" style="margin-top:20px">
                            ...
                            <div class="main">
                                    <div class="horizontal-form-elements">
                                            <form class="form-horizontal" action="<?php echo e(site_url('sistem/group/edit_process')); ?>" method="post">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" value="<?php echo e($result['group_name']); ?>" name="group_name" class="form-control" placeholder="Nama role...">
                                                            </div>
                                                        </div>
                                                    </div><!-- /# column -->
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <textarea rows="2" class="col-sm-12" name="group_desc" placeholder="Deskripsi role..."><?php echo e($result['group_desc']); ?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
