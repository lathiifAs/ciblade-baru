                    ...
                    <div class="card-body" style="margin-top:20px">
                        ...
                        <div class="main">
                                <div class="horizontal-form-elements">
                                    <form class="form-horizontal" action="<?php echo e(site_url('sistem/role/delete_process')); ?>" method="post">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-12">
                                                                <label class="control-label"><?php echo e($result['role_desc']); ?></label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
