<div class="content-wrap">
    <div class="main">
        ...
        <div style="margin-top:50px">
            Selamat datang <b> <?php echo e($user_login['user_name']); ?> </b>
        </div>
        tanggal saat ini : <?php echo e($tanggal); ?>
                        ...
                        <div class="col-lg-4">
                            <div class="card alert">
                                ...
                                <div class="recent-comment m-t-15">
                                    <div class="media">
                                        <div class="media-left">
                                            <a href="#"><img class="media-object" src="<?php echo base_url('assets/images/avatar/1.jpg')?>" alt="..."></a>
                                        </div>
                                 ...
                                 <div class="media">
                                    <div class="media-left">
                                        <a href="#"><img class="media-object" src="<?php echo base_url('assets/images/avatar/2.jpg')?>" alt="..."></a>
                                    </div>
                                    <div class="media-body">
                             ...
                             <div class="media no-border">
                                <div class="media-left">
                                    <a href="#"><img class="media-object" src="<?php echo base_url('assets/images/avatar/3.jpg')?>" alt="..."></a>
                                </div>
                                <div class="media-body">
