                    ...
                    <div class="card alert">
                        <div class="card-header">
                            ...
                            <div class="card-header-right-icon">
                                <ul>
                                    <a href="<?php  echo site_url('master/user/add')  ?>" type="button" class="btn btn-primary m-b-10 m-l-5">Tambah Data</a>
                                </ul>
                            </div>
                            <hr>
                        </div>
                                            ...
                                            <?php $__currentLoopData = $result; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                            ...
                                                            <a href="<?php  echo site_url('master/user/detail/'.$rs['user_id'])  ?>" type="button" class="btn btn-info btn-rounded m-b-10 m-l-5" title="Detail"><i class="ti-eye"></i></a>
                                                            <a href="<?php  echo site_url('master/user/edit/'.$rs['user_id'])  ?>" class="btn btn-warning btn-rounded m-b-10 m-l-5" title="Edit"><i class="ti-pencil"></i></a>
                                                            <a href="<?php  echo site_url('master/user/delete/'.$rs['user_id'])  ?>" class="btn btn-danger btn-rounded m-b-10 m-l-5" title="Delete"><i class="ti-trash"></i></button>
                                                    </td>
                                                </tr>
