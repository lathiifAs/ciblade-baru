                ...
                <ul>
                    ...
                    <?php if($user_login['role_nm'] == 'developer'): ?>
                        <li <?php if(!empty($seg_menu) and $seg_menu == 'role'): ?> class="active" <?php endif; ?>>
                                ...
                                <ul>
                                    <li><a href="<?php  echo site_url('sistem/role')  ?>">Role</a></li>
                                    <li><a href="<?php  echo site_url('sistem/group')  ?>">Group</a></li>
                                </ul>
                        </li>
                    <?php endif; ?>
                <li><a href="<?php  echo site_url('sistem/login/logout')  ?>"><i class="ti-close"></i> Logout</a></li>
                </ul>
            </div>
        </div>
    </div>