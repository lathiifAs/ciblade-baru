<div class="header">
        <div class="pull-left">
            <div class="logo">
                <a href="index.html">
                    <img id="logoImg" src="<?php  echo base_url('assets/logo/logo.png')  ?>" data-logo_big="<?php  echo base_url('assets/logo/logo.png')  ?>" data-logo_small="<?php  echo base_url('assets/logo/logoSmall.png"')  ?> alt="Nixon" />
                </a>
            </div>
        ...
        <div class="pull-right p-r-15">
            <ul>
                ...
                <li class="header-icon dib">
                    <img class="avatar-img" src="<?php  echo base_url('assets/images/avatar/1.jpg')  ?>" alt="" /> <span class="user-avatar"><?php echo e($user_login['user_name']); ?> <i class="ti-angle-down f-s-10"></i></span>
