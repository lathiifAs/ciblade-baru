...
<script src="<?php  echo base_url('assets/js/lib/jquery.plugin.js')  ?>"></script>
<!-- jquery vendor -->
<script src="<?php  echo base_url('assets/js/lib/jquery.nanoscroller.min.js')  ?>"></script>
<!-- nano scroller -->
<script src="<?php  echo base_url('assets/js/lib/sidebar.js')  ?>"></script>
<!-- sidebar -->
<script src="<?php  echo base_url('assets/js/lib/bootstrap.min.js')  ?>"></script>
<!-- bootstrap -->
<script src="<?php  echo base_url('assets/js/lib/mmc-common.js')  ?>"></script>
